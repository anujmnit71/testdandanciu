 ...
 * 
 * #define syscallHalt 		0 - done
 * #define syscallExit 		1 - done (still some work from JOIN syscall & filesystem part)
 * #define syscallExec 		2 - in work
 * #define syscallJoin 		3 - in work
...
public interface Syscall {
	 ...
	 */
	int exec(String file, int argc, String argv);
	 ...
	 */
	int join(int processID, Integer status);
