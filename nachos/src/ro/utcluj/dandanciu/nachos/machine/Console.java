...
import ro.utcluj.dandanciu.nachos.threads.Nachos;
...
public class Console {
  ...
  private ConsoleReadInterruptHandler consoleReadPoll;
  private ConsoleWriteInterruptHandler consoleWriteDone;
  ...
  public Console(String rdFile, String wrFile, Runnable readAvail, 
    ...
    consoleReadPoll = new ConsoleReadInterruptHandler(this);
    consoleWriteDone = new ConsoleWriteInterruptHandler(this);
...
//
class ConsoleReadInterruptHandler implements Runnable {
  private Console console;

  public ConsoleReadInterruptHandler(Console cons) {
    console = cons;
  }
...
//
class ConsoleWriteInterruptHandler implements Runnable {
  private Console console;

  public ConsoleWriteInterruptHandler(Console cons) {
    console = cons;
  }
