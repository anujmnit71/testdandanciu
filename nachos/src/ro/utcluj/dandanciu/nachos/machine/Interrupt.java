...
import ro.utcluj.dandanciu.nachos.threads.List;
import ro.utcluj.dandanciu.nachos.threads.ListElement;
import ro.utcluj.dandanciu.nachos.threads.Nachos;
import ro.utcluj.dandanciu.nachos.threads.NachosThread;
...
public class Interrupt {
  ...
  public static final int IntOff = 0;
// Interrupts can be disabled (IntOff) or enabled (IntOn)
  public static final int IntOn = 1;

  public static final int IdleMode = 0;
// Nachos can be running kernel code (SystemMode), user code (UserMode),
  // or there can be no runnable thread, because the ready list 
  // is empty (IdleMode).
  static final int SystemMode = 1;
  static final int UserMode=2;
